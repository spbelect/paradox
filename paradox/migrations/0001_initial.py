# Generated by Django 2.2.3 on 2019-07-01 04:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uik_complaint_status', models.CharField(choices=[('none', 'не подавалась'), ('refuse_to_accept', 'отказ принять жалобу'), ('refuse_to_resolve', 'отказ рассмотрения жалобы'), ('waiting_reply', 'ожидание решения комиссии'), ('got_unfair_reply', 'получено неудовлетворительное решение'), ('got_fair_reply', 'получено удовлетворительное решение')], max_length=20)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_status', models.CharField(default='pending', max_length=40)),
                ('time_created', models.DateTimeField(default=django.utils.timezone.now)),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='images', to='paradox.InputEvent')),
            ],
            options={
                'ordering': ('time_created',),
            },
